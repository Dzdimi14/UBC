...
delivery_domain = STRIPS_domain(
    ...
    { Strips('mc_cs', {'RLoc':'cs'}, {'RLoc':'off'}),
     ...
     Strips('puc', {'RLoc':'cs', 'RHC':False, 'RHM':False}, {'RHC':True}),  #added RHM false
     Strips('dc', {'RLoc':'off', 'RHC':True}, {'RHC':False, 'SWC':False}),
     Strips('pum', {'RLoc':'mr','MW':True, 'RHM':False, 'RHC':False}, {'RHM':True,'MW':False}), #added RHM false, RHC false
     Strips('dm', {'RLoc':'off', 'RHM':True}, {'RHM':False})
   } )


delivery_domain_box = STRIPS_domain(
    {'RLoc':{'cs', 'off', 'lab', 'mr'}, 'RHC':boolean, 'SWC':boolean,
     'MW':boolean, 'RHM':boolean, 'RHB':boolean},          #added 'RHB':boolean robot has box
    { Strips('mc_cs', {'RLoc':'cs'}, {'RLoc':'off'}),
     Strips('mc_off', {'RLoc':'off'}, {'RLoc':'lab'}),
     Strips('mc_lab', {'RLoc':'lab'}, {'RLoc':'mr'}),
     Strips('mc_mr', {'RLoc':'mr'}, {'RLoc':'cs'}),
     ...
     Strips('mcc_mr', {'RLoc':'mr'}, {'RLoc':'lab'}),
     Strips('puc', {'RLoc':'cs', 'RHC':False, 'RHM':False}, {'RHC':True}),  #added RHM false
     Strips('pcb', {'RLoc':'cs', 'RHC':False, 'RHM':True}, {'RHC':True, 'RHM':True, 'RHB':True}), #put coffee in box
     Strips('dc', {'RLoc':'off', 'RHC':True}, {'RHC':False, 'SWC':False}),
     Strips('pum', {'RLoc':'mr','MW':True, 'RHM':False, 'RHC':False}, {'RHM':True,'MW':False}), #added RHM false, RHC false
     Strips('pmb', {'RLoc':'mr', 'MW':True, 'RHM':False, 'RHC':True}, {'RHM':True, 'MW':False, 'RHC':True, 'RHB':True}), #put mail in box
     Strips('dm', {'RLoc':'off', 'RHM':True}, {'RHM':False})
   } )
...
new_problem = Planning_problem(delivery_domain,
                            {'RLoc':'lab', 'MW':True, 'SWC':True, 'RHC':True,
                             'RHM':False},
                            {'SWC':False, 'MW':False, 'RHM':False, 'RHC':False})
