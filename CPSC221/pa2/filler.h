...
namespace filler
{
        ...
        */
		...
		animation fillCustomDFS(PNG& img, int x, int y, HSLAPixel fillColor, double tolerance, int frameFreq);

		animation fillCustomBFS(PNG& img, int x, int y, HSLAPixel fillColor, double tolerance, int framFreq);
